...
const RecordAgreementAndStoreOpeningForm: React.FC<RecordAgreementAndStoreOpeningFormProps> = ({
  proposalId,
  initialData,
  onSubmit,
  onCancel,
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 bg-[#ece8e3] rounded-lg shadow-md max-w-lg mx-auto">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Record Agreement and Store Opening</h2>
