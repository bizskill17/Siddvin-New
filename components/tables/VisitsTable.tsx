            ...
            <tr key={visit.id}>
              ...
              <td className="relative whitespace-nowrap py-2.5 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                <div className="flex justify-end space-x-1">
                  {onEdit && (
                    <Button variant="primary" size="sm" onClick={() => onEdit(visit)} title="Edit" className="p-1">
                  ...
                  {onDelete && (
                    <Button variant="danger" size="sm" onClick={() => onDelete(visit.id)} title="Delete" className="p-1">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
